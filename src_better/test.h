...
const uint8_t SERVO_LED_ERROR_WRITE = 34;
const uint8_t SERVO_LED_ERROR_READ = 36;
class LewanSoul_LX16A_Enhanced {
public:
  LewanSoul_LX16A_Enhanced(HardwareSerial& serial);
...
private:
  ...
  int receivePacketVerbose(uint8_t id, uint8_t command);
